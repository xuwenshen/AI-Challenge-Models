...
class Dec(nn.Module):
    ...
    def __init__(self, zh_dims, dropout, zh_hidden, enc_hidden, atten_vec_size):
...
class Seq2Seq(nn.Module):
    ...
    def __init__(self, en_dims, zh_dims, dropout, en_hidden, zh_hidden, entext_len, atten_vec_size):
        ...
        self.dec_net = Dec(zh_dims=zh_dims, dropout=dropout, zh_hidden=zh_hidden, enc_hidden=en_hidden*2, atten_vec_size=atten_vec_size)
    ...
    def forward(self, inputs, gtruths, inputs_len, ssprob, is_train):
        ...
        logits, predic = self.dec_net(self.rnn_enc, gtruths, ssprob, is_train)
