...
bleuscore = BLEUScore()
model_dir = '/data/xuwenshen/ai_challenge/code/ibm_seq2seq/models/'
...
def test(net, test_loader, transform, batch_size):
    ...
    for (_, data) in enumerate(test_loader, 0):
        ...
        decoder_outputs, ret_dict = net(entext, None, enlen, beam_mode, 0)
    ...
    print ('writing....')
    fout = open('/data/xuwenshen/ai_challenge/code/ibm_seq2seq/pred.txt', 'w')
...
if __name__ == '__main__':
    ...
    pre_trained = torch.load('/data/xuwenshen/ai_challenge/code/ibm_seq2seq/models/ratio-0.987973-loss-6.481453-score-0.352274-steps-121000-model.pkl')
