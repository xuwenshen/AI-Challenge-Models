...
bleuscore = BLEUScore()
model_dir = '/data/xuwenshen/ai_challenge/code/cnn_rnn/models/'
        ...
        for (_, data) in enumerate(train_loader, 0):
            ...
            if batchid % 400 == 0:
                ...
                if  best_valid_loss > all_loss or best_score < score:
                    ...
                    bestscore = score
                    torch.save(net.state_dict(), model_dir + "ssprob-{:3f}-loss-{:3f}-steps-{:d}-model.pkl".format(ssprob, all_loss, global_steps))
